  ...
  <div class="header">
    ...
    <div style="flex: 0 1 35%; min-width: 180px; display: flex; flex-direction: column; align-items: center;">
      <div style="margin-bottom: 15px;">
        <img src="profile.png" alt="Profile Photo" style="width: 110px; height: 110px; border-radius: 8px; object-fit: cover; object-position: top center; box-shadow: 0 0 8px rgba(0,0,0,0.2); border: 2px solid #1a5276;">
      </div>
...
<div id="LinkedIn-Learning" class="containerTab section-block">
  ...
  <ul style="list-style: disc; padding-left: 20px;">
    ...
    <li>
      <a href="https://www.linkedin.com/learning/certificates/09de5d182c33f50b83513bc8b15cb0a4a7c3b1d5aec5fe180be221fa438dd5f1?trk=share_certificate" target="_blank">
         <!--img src="Linkedin.png" alt="LinkedIn Logo" style="width:22px; height:22px; margin-right:8px;" onerror="this.style.display='none'" -->
        <i class="fa-brands fa-linkedin"></i>
